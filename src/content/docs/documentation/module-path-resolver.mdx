...
head:
  - tag: meta
    attrs:
      property: og:image
      content: https://wc-toolkit.com/images/wc-toolkit_module-path-resolver.png
  - tag: meta
    attrs:
...
<Aside>If you are not transpiling or building your components and your source file is in the same place as the final output, you probably don't need to add this.</Aside>
...
<Aside>Your analyzer may already be doing this for you. You can confirm this by searching your manifest for any `exports` with `"kind": "custom-element-definition"`.</Aside>
...
<Aside>This is only needed of the types are not co-located with the module or if it follows a different naming convention from the component module.</Aside>
