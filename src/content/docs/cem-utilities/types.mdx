...
The following are a set of types that extend the Custom Elements Manifest types to allow for strongly typing your custom data. 
These types are used throughout the CEM utilities to provide a more robust and type-safe experience when working with the CEM.
