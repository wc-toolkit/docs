...
<Aside>Many of these methods use the [Custom CEM Types](/cem-utilities/types), so please take a look at those documentation for more detailed information about how to use them.</Aside>
...
```ts
type Component = cem.CustomElement & Record<string, unknown> & {
...
<Aside>If you're not already, it's highly recommended that you use a tool like the [Module Path Resolver](/documentation/module-path-resolver/) to ensure this content is accurate in your Custom Elements Manifest.</Aside>
