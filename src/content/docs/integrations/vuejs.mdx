---
title: Vue.js Types Generator
description: Generate Vue.js types for custom elements / web components
head:
  - tag: meta
    attrs:
      property: og:image
      content: https://wc-toolkit.com/images/wc-toolkit_vuejs.png
  - tag: meta
    attrs:
...
hero:
  title: 'Vue.js Types Generator'
  tagline: Generate Vue.js types for custom elements / web components
  image:
    alt: A workbench with tools, html, css, javascript, and Vue.js logo
    file: ../../../assets/wc-toolkit_vuejs.png
---
...
<Aside>
For more information on integrating with Vue, see the [Vue.js documentation](https://vuejs.org/guide/extras/web-components.html).
</Aside>
