...
<Aside>
  If you are using React v19+, you can now use custom elements directly without
  needing wrappers. Be sure to check out the [JSX Types generator
  package](https://wc-toolkit.com/integrations/jsx/) to provide type-safe web
  components in your JSX templates.
</Aside>
