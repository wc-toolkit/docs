...
description: Generate react wrappers for your custom elements / web components
head:
  - tag: meta
    attrs:
      property: og:image
      content: https://wc-toolkit.com/images/wc-toolkit_react.png
  - tag: meta
    attrs:
...
hero:
  title: 'React Wrappers'
  tagline: Generate react wrappers for your custom elements / web components
  image:
    alt: A workbench with tools, html, css, javascript, and JSX logo
    file: ../../../assets/wc-toolkit_react.png
---
...
<Aside>If you are using React v19+, you can now use custom elements directly without needing wrappers. Be sure to check out the [JSX Types generator package](https://wc-toolkit.com/integrations/jsx/) to provide type-safe web components in your JSX templates.</Aside>
