...
A powerful Visual Studio Code extension (but more to come) that provides intelligent language support for development with Web Components. This extension enhances your development experience with advanced IntelliSense and validation for Web Components.
