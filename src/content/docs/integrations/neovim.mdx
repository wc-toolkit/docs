---
title: Web Components Language Server - Neovim
description: Editor support for web components / custom elements
head:
  - tag: meta
    attrs:
      property: og:image
      content: https://wc-toolkit.com/images/wc-toolkit_neovim.png
  - tag: meta
    attrs:
...
hero:
  ...
  image:
    alt: A workbench with tools, html, css, javascript, and neovim logo
    file: ../../../assets/wc-toolkit_neovim.png
---
...
<Aside> For more information on how to configure the language server, see the [configuration documentation](http://wc-tools.com/integrations/wctools#custom-configuration). </Aside>
